...
bool http::RequestParser::is_request_line_finished() const
{
	return m_slp.is_finished();
}

bool http::RequestParser::are_headers_finished() const
{
	return m_hp.is_finished();
}
